"""This module creates a list of favourite movies and TV shows to be displayed
 by fresh_tomatoes.py"""
...
shawshank = media.Movie("The Shawshank Redemption",
                        ...
                        finding solace & eventual redemption through acts \
                        of common decency.",
...
matrix = media.Movie("The Matrix",
                     ...
                     the true nature of his reality & his role in the war \
...
blood = media.Movie("There Will Be Blood",
                    ...
                    focusing on a turn-of-the-century prospector in the \
...
old_men = media.Movie("No Country for Old Men",
                      ...
                      "Violence and mayhem ensue after a hunter stumbles upon \
                      a drug deal gone wrong and more than two million \
...
orange = media.Movie("A Clockwork Orange",
                     ...
                     "In future Britain, charismatic delinquent Alex DeLarge \
                     is jailed and volunteers for an experimental aversion \
                     therapy developed by the government in an effort to \
                     solve society's crime problem - but not all goes \
                     according to plan.",
...
crazy = media.Movie("The Gods Must Be Crazy",
                    ...
                    "A comic allegory about a traveling Bushman who encounters\
                    modern civilization and its stranger aspects, including a \
                    clumsy scientist and a band of revolutionaries.",
...
district = media.Movie("District 9",
                       ...
                       "An extraterrestrial race forced to live in slum-like \
                       conditions on Earth suddenly finds a kindred spirit in \
                       a government agent who is exposed to their \
                       biotechnology.",
                       "Sharlto Copley, David James, Jason Cope")

my_fav_movies = [shawshank, matrix, old_men, blood, walle, orange, crazy,
                 juno, district]
